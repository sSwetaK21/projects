...
form.addEventListener("submit", function (e){
    ...
    if(isNaN(value) || value < 1 || value >9 ){
        contentbox.innerHTML = `<p class="contentbox" align="center">${randomText[random]}
        </p><br>`
    }else{
        let temp = randomText.slice(0, value)
        temp = temp.map(function (item){
            return `<p class="contentbox" align="center">${randomText[random]}
            </p> <br>`
        }).join("")
        contentbox.innerHTML = temp
    }
})